...
from src.lib.parser.jianwks_parser import JinWanKanSaArticleParser, JinWanKanSaColumnParser
import re
...
class JinWanKanSaWorker(object):
    @staticmethod
    def catch(account_id):
        ...
        #   获取每一页中文章的地址的地址
        for raw_front_page_index in range(1, max_page+1):
