...
from src.lib.parser.xueqiu_parser import XueQiuColumnParser, XueQiuTodayArticleParser
import time
...
class XueQiuTodayWorker(object):
    @staticmethod
    def catch(account_id):
        ...
        # all
        # _url = "https://xueqiu.com/statuses/search.json?count=10&comment=0&symbol={0}&hl=0&source=all&sort=&page={1}&q="
        ...
        with open('ReadList.txt', 'r') as read_list:
            ...
            for line in read_list:
                ...
                if split_url.split('/')[-1] == account_id:
                    ...
                    column_info[u'title'] = u"{}_{}".format(tit, 'alpha')
                    # column_info[u'title'] = u"{}".format(tit)
        ...
        while len(index_work_set) > 0 and re_catch_counter <= 20:
            ...
            for article_url_index in index_work_set:
                ...
                for article in articles:
                    ...
                    article_info = XueQiuTodayArticleParser(article).get_article_info()
