...
from src.lib.parser.wuxia_parser import WuXiaArticleParser, WuXiaColumnParser
import re
...
class WuXiaWorker(object):
    ...
    def catch(account_id):
        ...
        for raw_front_page_index in range(0, max_page):
            request_url = u'https://www.wuxiareview.com/category/{}/{}/'.format(account_id, raw_front_page_index)
        ...
        while len(index_work_set) > 0 and re_catch_counter <= 20:
            ...
            for article_url_index in index_work_set:
                ...
                article_info = WuXiaArticleParser(request_url_content).get_article_info()
