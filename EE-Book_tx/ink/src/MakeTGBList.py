...
if __name__ == '__main__':
    ...
    u = u'http://www.jianshu.com/c/d54cfa16cea8'
    xc = Http.get_content(u)
    dom = BeautifulSoup(xc,"lxml")

    indexNum = dom.find_all('div',class_="info")[0]
    indurl  =filter(str.isdigit,str(indexNum.get_text().split(u'·')[0]))
    print indurl
